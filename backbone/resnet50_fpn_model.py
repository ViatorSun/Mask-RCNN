...
def resnet50_fpn_backbone(pretrain_path="", norm_layer=nn.BatchNorm2d,
    ...
    out_channels = 256
    x = BackboneWithFPN(resnet_backbone, return_layers, in_channels_list, out_channels, extra_blocks=extra_blocks)
    return x