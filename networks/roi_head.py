...
class RoIHeads(torch.nn.Module):
    ...
    def __init__(self, box_roi_pool, box_head, box_predictor,  # Multi-scale RoIAlign pooling, TwoMLPHead, FastRCNNPredictor
                 ...
                 score_thresh, nms_thresh, detection_per_img,   # default: 0.05, 0.5, 100
        ...
        self.proposal_matcher = det_utils.Matcher(  fg_iou_thresh,  # default: 0.5
                                                    bg_iou_thresh,  # default: 0.5
                                                    allow_low_quality_matches=False)

        self.fg_bg_sampler  = det_utils.BalancedPositiveNegativeSampler(batch_size_per_image,  # default: 512
    ...
    def select_training_samples(self, proposals, targets):
        # type: (List[Tensor],Optional[List[Dict[str, Tensor]]]) -> Tuple
